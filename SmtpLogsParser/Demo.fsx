...
let test p str =
    ...
    | Success(result, _, _) -> printfn "Success: %A" (MetaString.render result)
...
let logLines =
    [ "(451- 4.7.652 The mail server) [88.216.57.52] has exceeded the maximum number of connections. (S3115) [DU6PEPF0000A7E0.eurprd02.prod.outlook.com 2024-08-01T10:08:12.503Z 08DCAFACFDA32292]"
      ...
      "550- Message was not accepted -- invalid mailbox. Local mailbox 89263491107@mail.ru is unavailable: account is disabled"
